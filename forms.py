...
#    email = forms.EmailField(max_length=50, label='Email:', required=False)
    description = forms.CharField(widget=forms.Textarea, label='Background - tell us about yourself!', required=False)
    club = forms.CharField(widget=forms.Textarea, label='School/Club affiliation:', required=False)
