...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Forfeit.team1_noshow'
        db.add_column(u'CGL_forfeit', 'team1_noshow',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Forfeit.team2_noshow'
        db.add_column(u'CGL_forfeit', 'team2_noshow',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Forfeit.team1_noshow'
        db.delete_column(u'CGL_forfeit', 'team1_noshow')

        # Deleting field 'Forfeit.team2_noshow'
        db.delete_column(u'CGL_forfeit', 'team2_noshow')
