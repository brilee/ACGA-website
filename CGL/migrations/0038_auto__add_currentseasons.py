...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CurrentSeasons'
        db.create_table('CGL_currentseasons', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('CGL', ['CurrentSeasons'])

        # Adding M2M table for field current_seasons on 'CurrentSeasons'
        m2m_table_name = db.shorten_name('CGL_currentseasons_current_seasons')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('currentseasons', models.ForeignKey(orm['CGL.currentseasons'], null=False)),
            ('season', models.ForeignKey(orm['CGL.season'], null=False))
        ))
        db.create_unique(m2m_table_name, ['currentseasons_id', 'season_id'])


    def backwards(self, orm):
        # Deleting model 'CurrentSeasons'
        db.delete_table('CGL_currentseasons')

        # Removing M2M table for field current_seasons on 'CurrentSeasons'
        db.delete_table(db.shorten_name('CGL_currentseasons_current_seasons'))
    ...
    models = {
        ...
        'CGL.currentseasons': {
            'Meta': {'object_name': 'CurrentSeasons'},
            'current_seasons': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['CGL.Season']", 'symmetrical': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        'CGL.forfeit': {
        ...
        'CGL.school': {
            ...
            'KGS_password': ('django.db.models.fields.CharField', [], {'max_length': '50', 'blank': 'True'}),
            ...
            'secondary_contacts': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
            'slug_name': ('django.db.models.fields.SlugField', [], {'max_length': '50', 'blank': 'True'}),
        ...
        'CGL.season': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_championship': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        'CGL.team': {
            'Meta': {'ordering': "['-season__pk', '-num_wins', 'num_losses', '-num_ties', 'num_forfeits']", 'object_name': 'Team'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
