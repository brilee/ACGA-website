...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Forfeit.forfeit'
        db.delete_column('CGL_forfeit', 'forfeit')


    def backwards(self, orm):
        # Adding field 'Forfeit.forfeit'
        db.add_column('CGL_forfeit', 'forfeit',
                      self.gf('django.db.models.fields.CharField')(default='School1', max_length=10),
                      keep_default=False)
