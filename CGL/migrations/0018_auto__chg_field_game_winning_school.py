...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Game.winning_school'
        db.alter_column(u'CGL_game', 'winning_school', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Game.winning_school'
        raise RuntimeError("Cannot reverse this migration. 'Game.winning_school' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Game.winning_school'
        db.alter_column(u'CGL_game', 'winning_school', self.gf('django.db.models.fields.CharField')(max_length=10))
