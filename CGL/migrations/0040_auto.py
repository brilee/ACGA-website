...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        m2m_table_name = db.shorten_name('CGL_team_players')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('team', models.ForeignKey(orm['CGL.team'], null=False)),
            ('player', models.ForeignKey(orm['CGL.player'], null=False))
        ))
    ...
    def backwards(self, orm):
        ...
        db.delete_table(db.shorten_name('CGL_team_players'))
    ...
    models = {
        ...
        'CGL.team': {
            ...
            'num_wins': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'players': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['CGL.Player']", 'symmetrical': 'False'}),
            'school': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['CGL.School']"}),
            'season': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['CGL.Season']"}),
