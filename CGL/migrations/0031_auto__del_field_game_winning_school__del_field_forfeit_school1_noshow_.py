...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Game.winning_school'
        db.delete_column(u'CGL_game', 'winning_school')

        # Deleting field 'Forfeit.school1_noshow'
        db.delete_column(u'CGL_forfeit', 'school1_noshow')

        # Deleting field 'Forfeit.school2_noshow'
        db.delete_column(u'CGL_forfeit', 'school2_noshow')

        # Deleting field 'Bye.school'
        db.delete_column(u'CGL_bye', 'school_id')

        # Deleting field 'Match.school2'
        db.delete_column(u'CGL_match', 'school2_id')

        # Deleting field 'Match.school1'
        db.delete_column(u'CGL_match', 'school1_id')


    def backwards(self, orm):
        # Adding field 'Game.winning_school'
        db.add_column(u'CGL_game', 'winning_school',
                      self.gf('django.db.models.fields.CharField')(max_length=10, null=True),
                      keep_default=False)

        # Adding field 'Forfeit.school1_noshow'
        db.add_column(u'CGL_forfeit', 'school1_noshow',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Forfeit.school2_noshow'
        db.add_column(u'CGL_forfeit', 'school2_noshow',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'Bye.school'
        raise RuntimeError("Cannot reverse this migration. 'Bye.school' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Bye.school'
        db.add_column(u'CGL_bye', 'school',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['CGL.School']),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'Match.school2'
        raise RuntimeError("Cannot reverse this migration. 'Match.school2' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Match.school2'
        db.add_column(u'CGL_match', 'school2',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='school2', to=orm['CGL.School']),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'Match.school1'
        raise RuntimeError("Cannot reverse this migration. 'Match.school1' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Match.school1'
        db.add_column(u'CGL_match', 'school1',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='school1', to=orm['CGL.School']),
                      keep_default=False)
    ...
    models = {
        u'CGL.bye': {
            ...
            'team': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['CGL.Membership']", 'null': 'True'})
        },
        u'CGL.forfeit': {
