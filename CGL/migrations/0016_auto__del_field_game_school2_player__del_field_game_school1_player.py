...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Game.school2_player'
        db.delete_column(u'CGL_game', 'school2_player_id')

        # Deleting field 'Game.school1_player'
        db.delete_column(u'CGL_game', 'school1_player_id')


    def backwards(self, orm):
        # Adding field 'Game.school2_player'
        db.add_column(u'CGL_game', 'school2_player',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='game_school2_player', to=orm['CGL.Player']),
                      keep_default=False)

        # Adding field 'Game.school1_player'
        db.add_column(u'CGL_game', 'school1_player',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='game_school1_player', to=orm['CGL.Player']),
                      keep_default=False)
