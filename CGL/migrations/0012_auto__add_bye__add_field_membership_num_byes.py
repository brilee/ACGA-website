...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('CGL', ['Bye'])

        # Adding field 'Membership.num_byes'
        db.add_column('CGL_membership', 'num_byes',
    ...
    def backwards(self, orm):
        # Deleting model 'Bye'
        db.delete_table('CGL_bye')

        # Deleting field 'Membership.num_byes'
        db.delete_column('CGL_membership', 'num_byes')
