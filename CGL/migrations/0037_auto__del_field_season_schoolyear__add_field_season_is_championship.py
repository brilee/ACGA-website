...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Season.schoolyear'
        db.delete_column('CGL_season', 'schoolyear')

        # Adding field 'Season.is_championship'
        db.add_column('CGL_season', 'is_championship',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Season.schoolyear'
        db.add_column('CGL_season', 'schoolyear',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=40),
                      keep_default=False)

        # Deleting field 'Season.is_championship'
        db.delete_column('CGL_season', 'is_championship')
