...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Membership.team_name'
        db.add_column(u'CGL_membership', 'team_name',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Membership.team_name'
        db.delete_column(u'CGL_membership', 'team_name')
    ...
    models = {
        ...
        u'CGL.membership': {
            ...
            'team_name': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '30'})
        },
        u'CGL.player': {
