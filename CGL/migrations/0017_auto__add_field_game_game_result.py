...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Game.game_result'
        db.add_column(u'CGL_game', 'game_result',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=10, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Game.game_result'
        db.delete_column(u'CGL_game', 'game_result')
    ...
    models = {
        ...
        u'CGL.game': {
            ...
            'board': ('django.db.models.fields.CharField', [], {'max_length': '1'}),
            'game_result': ('django.db.models.fields.CharField', [], {'max_length': '10', 'blank': 'True'}),
