...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Player.contact_email'
        db.add_column('CGL_player', 'contact_email',
                      self.gf('django.db.models.fields.EmailField')(default='', max_length=75, blank=True),
                      keep_default=False)

        # Adding field 'Player.receiveSpam'
        db.add_column('CGL_player', 'receiveSpam',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Player.contact_email'
        db.delete_column('CGL_player', 'contact_email')

        # Deleting field 'Player.receiveSpam'
        db.delete_column('CGL_player', 'receiveSpam')
