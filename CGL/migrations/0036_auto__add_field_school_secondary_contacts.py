...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'School.secondary_contacts'
        db.add_column('CGL_school', 'secondary_contacts',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'School.secondary_contacts'
        db.delete_column('CGL_school', 'secondary_contacts')
