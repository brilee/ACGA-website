...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Membership.still_participating'
        db.add_column('CGL_membership', 'still_participating',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Membership.still_participating'
        db.delete_column('CGL_membership', 'still_participating')
