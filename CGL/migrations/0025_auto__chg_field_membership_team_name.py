...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Membership.team_name'
        db.alter_column(u'CGL_membership', 'team_name', self.gf('django.db.models.fields.CharField')(max_length=60))

    def backwards(self, orm):

        # Changing field 'Membership.team_name'
        db.alter_column(u'CGL_membership', 'team_name', self.gf('django.db.models.fields.CharField')(max_length=30))
