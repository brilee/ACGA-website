...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'CGL_laddergame', (
            ...
            ('white_player', self.gf('django.db.models.fields.related.ForeignKey')(related_name='white_player_laddergame', null=True, to=orm['CGL.Player'])),
            ('black_player', self.gf('django.db.models.fields.related.ForeignKey')(related_name='black_player_laddergame', null=True, to=orm['CGL.Player'])),
        ...
        # Adding field 'Game.handicap'
        db.add_column(u'CGL_game', 'handicap',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Game.handicap'
        db.delete_column(u'CGL_game', 'handicap')
    ...
    models = {
        ...
        u'CGL.game': {
            ...
            'black_player': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'black_player_game'", 'null': 'True', 'to': u"orm['CGL.Player']"}),
            'board': ('django.db.models.fields.CharField', [], {'max_length': '1'}),
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'match': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['CGL.Match']"}),
            'white_player': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'white_player_game'", 'null': 'True', 'to': u"orm['CGL.Player']"}),
        ...
        u'CGL.laddergame': {
            ...
            'black_player': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'black_player_laddergame'", 'null': 'True', 'to': u"orm['CGL.Player']"}),
            'game_result': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '10', 'blank': 'True'}),
            'gamefile': ('django.db.models.fields.files.FileField', [], {'max_length': '100'}),
            'handicap': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'season': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['CGL.Season']", 'blank': 'True'}),
            'white_player': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'white_player_laddergame'", 'null': 'True', 'to': u"orm['CGL.Player']"})
        },
        u'CGL.match': {
