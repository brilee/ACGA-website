...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Game.white_player'
        db.add_column(u'CGL_game', 'white_player',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='white_player', null=True, to=orm['CGL.Player']),
                      keep_default=False)

        # Adding field 'Game.black_player'
        db.add_column(u'CGL_game', 'black_player',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='black_player', null=True, to=orm['CGL.Player']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Game.white_player'
        db.delete_column(u'CGL_game', 'white_player_id')

        # Deleting field 'Game.black_player'
        db.delete_column(u'CGL_game', 'black_player_id')
