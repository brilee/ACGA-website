...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('CGL_forfeit', 'school1_noshow',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Forfeit.school2_noshow'
        db.add_column('CGL_forfeit', 'school2_noshow',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('CGL_forfeit', 'school1_noshow')

        # Deleting field 'Forfeit.school2_noshow'
        db.delete_column('CGL_forfeit', 'school2_noshow')
