...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Bye.team'
        db.add_column(u'CGL_bye', 'team',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['CGL.Membership'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Bye.team'
        db.delete_column(u'CGL_bye', 'team_id')
