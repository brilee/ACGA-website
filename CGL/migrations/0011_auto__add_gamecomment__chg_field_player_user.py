...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('CGL_gamecomment', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('game', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['CGL.Game'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('datetime', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('comment', self.gf('django.db.models.fields.TextField')(max_length=1000)),
        ))
        db.send_create_signal('CGL', ['GameComment'])


        # Changing field 'Player.user'
        db.alter_column('CGL_player', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True, null=True, on_delete=models.SET_NULL))

    def backwards(self, orm):
        # Deleting model 'GameComment'
        db.delete_table('CGL_gamecomment')


        # Changing field 'Player.user'
        db.alter_column('CGL_player', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True, null=True))
