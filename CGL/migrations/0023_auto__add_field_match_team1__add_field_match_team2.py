...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Match.team1'
        db.add_column(u'CGL_match', 'team1',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='team1', null=True, to=orm['CGL.Membership']),
                      keep_default=False)

        # Adding field 'Match.team2'
        db.add_column(u'CGL_match', 'team2',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='team2', null=True, to=orm['CGL.Membership']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Match.team1'
        db.delete_column(u'CGL_match', 'team1_id')

        # Deleting field 'Match.team2'
        db.delete_column(u'CGL_match', 'team2_id')
    ...
    models = {
        ...
        u'CGL.membership': {
            ...
            'team_name': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '30', 'blank': 'True'})
        },
        u'CGL.player': {
